...
const EditVirtualMeeting = () => {
    ...
    const [coordinator, setMCoordinatorName] = useState('')
    ...
    const handelDataSubmit = ()=>{
         console.log("inside handelData submit")
         createMeeting();
    }

    const createMeeting = async () => {
        try {
          const response = await axios.post('http://localhost:5000/checkDate',{meetingDate:sdate}); // You can pass any request data here
          ...
          if(response?.data?.errorCode =='1'){
            ...
            console.log(hostId)
            const res = await axios.post('http://localhost:5000/createZoomMeeting',{topic:title,duration,start_time:sdate,hostId})
            if(res.data.errorCode=="1"){
                alert(`meeting created in account ${accountNum}`)
            }
          }
          else{
            
          //const response = await axios.post('http://localhost:8088/createZoomMeeting',{topic,agenda,duration,start_time:ddate}); // You can pass any request data here
          //setMeeting(response.data);
          //console.log("inside meting responce",response)
          console.log(response?.data?.message)
          alert("all account have meeting");
                                                        ...
                                                        <div className="col-lg-12 col-xl-12">
                                                            ...
                                                            <ul className="nav nav-tabs md-tabs " role="tablist">
                                                                ...
                                                                <li className="nav-item" onClick={()=>handelIndexChange(2)}>
                                                                    <a className={`nav-link ${currentIndex===2 ?'active':""}`} data-toggle="profile7"
                                                                        href="#profile7" data-target="profile7" role="tab"><i
                                                                ...
                                                                <li className="nav-item" onClick={()=>handelIndexChange(4)}>
                                                                    <a className={`nav-link ${currentIndex===4 ?'active':""}`} data-toggle="tab"
                                                            ...
                                                            <div className="tab-content card-block">
                                                                {currentIndex===1 ? (<div className="tab-pane active" id="home7" role="tabpanel">
                                                                    <form action="" className="mx-auto ">
                                                                        ...
                                                                        <div className="form-group row container mx-auto">
                                                                            <label
                                                                                className="col-sm-4 col-form-label">MCoordinator
                                                                                Name</label>
                                                                            <div className="col-sm-8">
                                                                                <input type="text" className="form-control" onChange={(e)=>{
                                                                ...
                                                                </div>): currentIndex===2 ? (<div className="tab-pane active" id="profile7" role="tabpanel">
    ...
    <div className="form-group row container mx-auto">
        ...
        <div className="col-sm-8">
            <label className="labelcs ">
                <input type="checkbox"
                    name="checkboxOne" value="one"/>
                One
            </label>

            <label className="labelcs ">
                <input type="checkbox"
                    name="checkboxTwo" value="two"/>
                Two
            </label>
    ...
    <div className="text-right">
                                                                    ...
                                                                    <div className="">
                                                                        ...
                                                                        <button
                                                                            className="btn hor-grd btn-grd-primary float-right"
                                                                            data-toggle="tab" href="#profile7"
                                                                            onClick={()=>{handelIndexChange(4);handelDataSubmit()}}
                                                                            role="tab">
